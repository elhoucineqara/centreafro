    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-md overflow-hidden">
            ...
            >
                ...
                {/* Header Section */}
                <div className="relative h-32 bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 p-6 flex items-end">
                    ...
                    <div className="relative z-10 flex items-center gap-5 w-full">
                        <div className="relative w-24 h-24 rounded-2xl overflow-hidden shadow-xl ring-4 ring-white/30 bg-white translate-y-8">
                            {member.photoUrl ? (
                                <Image
                                    src={member.photoUrl}
                        ...
                        <div className="flex flex-col gap-0 text-white mb-1">
                            ...
                            <h3 className="text-lg font-bold bg-white/10 px-2.5 py-0.5 rounded-lg backdrop-blur-sm self-start" dir="rtl">
                ...
                {/* Content Area */}
                <div className="pt-14 px-8 pb-6 space-y-6 max-h-[85vh] overflow-y-auto custom-scrollbar">

                    {/* section 1: Personal */}
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-4 relative">
                        <div className="absolute -left-3 top-0 bottom-0 w-1 bg-blue-100/50 rounded-full"></div>
                        <InfoItem label="رقم البطاقة (CNI)" value={<span className="uppercase tracking-widest">{member.cni}</span>} />
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-4 relative">
                        <div className="absolute -left-3 top-0 bottom-0 w-1 bg-indigo-100/50 rounded-full"></div>
                                ...
                                {member.phone && (
                                    <div className="flex items-center gap-2.5 bg-blue-50 px-4 py-2 rounded-xl border border-blue-100">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-bold text-blue-400 uppercase">الهاتف</span>
                                            <span className="text-xs font-bold text-gray-700">{member.phone}</span>
                                        </div>
                                    </div>
                                )}
                                {member.email && (
                                    <div className="flex items-center gap-2.5 bg-indigo-50 px-4 py-2 rounded-xl border border-indigo-100">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-bold text-indigo-400 uppercase">البريد الإلكتروني</span>
